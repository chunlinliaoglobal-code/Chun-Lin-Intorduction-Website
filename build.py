...
teaching_gallery = '<section class="internship-gallery-section" aria-labelledby="teaching-gallery-heading"><h2 id="teaching-gallery-heading" class="group-title">Learning by Building</h2><div class="internship-gallery teaching-gallery"><figure class="internship-figure"><a class="band-photo" href="assets/teaching/four-bit-counter-project.png" target="_blank" rel="noopener noreferrer" aria-label="View 4-bit counter project"><img src="assets/teaching/four-bit-counter-project.png" alt="4-bit counter project with a development board, breadboard wiring, and seven-segment displays" width="2048" height="1536" loading="lazy" decoding="async"></a><figcaption><span class="figure-number">Fig. 1</span>4-Bit Counter Project</figcaption></figure><figure class="internship-figure"><a class="band-photo" href="assets/teaching/fpga-programming-tutorial.png" target="_blank" rel="noopener noreferrer" aria-label="View pin assignment and FPGA programming tutorial"><img src="assets/teaching/fpga-programming-tutorial.png" alt="Recorded DE0-Nano tutorial demonstrating pin assignments and FPGA programming in Quartus" width="1913" height="782" loading="lazy" decoding="async"></a><figcaption><span class="figure-number">Fig. 2</span>Pin Assignment &amp; FPGA Programming Tutorial<br>Recorded supplementary instructional materials for the DE0-Nano laboratory.</figcaption></figure></div></section>'
...
for idx, (key, label, filename, title, content) in enumerate(page_specs):
    ...
    if key == 'teaching':
        page_head = page_head.replace('</head>', '<link rel="stylesheet" href="assets/internships/gallery.css?v=1"><link rel="stylesheet" href="assets/teaching/gallery.css?v=2"></head>')
    if key == 'education':
        page_head = page_head.replace('</head>', '<link rel="stylesheet" href="assets/internships/gallery.css?v=1"></head>')
