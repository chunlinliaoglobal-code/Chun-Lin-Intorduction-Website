...
dict(kind='Manuscript in preparation',title='Simulation-Based Operating-Window Optimization for Lithium-Ion Batteries Using Taguchi Design, Surrogate Modeling, and Multi-Algorithm Search',authors='Liao, C.-L. · Sole author',venue='Planned submission to the International Journal of Innovative Computing, Information and Control (IJICIC) (ESCI; JCR Q4; Scopus Q2)',note='Manuscript in preparation.',details=[
...
'Reported 100% schema exactness and strict balanced accuracy in a controlled two-protocol, execution-based benchmark, with 37.8% lower token usage than vanilla RAG under constrained repeated runs.'],links=[('https://taai2026.github.io/','Conference website')]),
...
pubs=''
for group,inds in [('Journal manuscripts in preparation',[0,1]),('Conference papers & presentations',[2,6,3,4,7,5])]:
...
'Projects: Orion AI Orchestrator and enterprise RAG solutions for BankTaiwan Life Insurance and FamilyMart.',
...
'AI Sewer Pipeline Anomaly Detection — Sewerage Systems Office.',
'AI Water-Quality Monitoring — Kbro × New Taipei City Environmental Protection Department.',
'AI Occupational-Safety Recognition — Taipei Water Department.',
'Audie AI Multi-Agent Document Review System — MOEA Value Creation Program.']),links=[('https://ucore.com.tw/','Company website')])
...
education+='<h3 class="group-title">Relevant coursework</h3><div class="table-wrap"><table><caption>Jointly offered courses and reported grades</caption><thead><tr><th>Course level</th><th>Course</th><th>Grade / status</th></tr></thead><tbody>'+''.join(f'<tr><td>{a}</td><td>{b}</td><td>{c}</td></tr>' for a,b,c in courses)+'</tbody></table></div>'
...
page_specs = [
    ...
    ('leadership', 'Beyond Research', 'beyond-research.html', 'Beyond Research', leadership),
]
